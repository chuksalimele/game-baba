...
class Tournament extends WebApplication {
     ...
     * tournament match (complete sets) to promote the winner to the next round.
     *  
     ...
     * But when nothing after all can separate the players then the server will
     ...
     * Note: cancelled seasons will not be used
     *  
     * @param {type} tourn
