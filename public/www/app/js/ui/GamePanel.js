...
Ns.ui.GamePanel = {
    ...
    exitDestopApplication: function(){
        ...
        , 'Are you sure you want to exit this application?', 'Close');
    ...
    ownGameView: function (match) {
        ...
        if (Main.device.isDesktopApplication) {
            me._createMenu("#game-view-menu-desktop-app");
            $('#game-view-exit-desktop-app').on('click', this.exitDestopApplication);
        } else {
    ...
    ownGameViewB: function (match) {
        ...
        if (Main.device.isDesktopApplication) {
            me._createMenu("#game-view-b-menu-desktop-app");
            $('#game-view-b-exit-desktop-app').on('click', this.exitDestopApplication);
        } else {
    ...
    watchGame: function (match) {
        ...
        if (Main.device.isDesktopApplication) {
            me._createMenu("#game-watch-menu-desktop-app");
            $('#game-watch-exit-desktop-app').on('click', this.exitDestopApplication);
        } else {
